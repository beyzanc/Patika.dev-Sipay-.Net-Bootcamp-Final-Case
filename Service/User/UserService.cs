...
namespace ResiPay.Service.User
{
    public class UserService : IUserService
    {
        ...
        public UserService(IMapper _mapper, UserInsertValidator _validator, ResiPayDbContext dbContext)
        {
            this.mapper = _mapper;
        ...
        public Base<UserViewModel> Insert(UserInsertModel newInsert)
        {
            ...
            else
            {
                ...
                {
                    var apartment = dbContext.Apartment
                        .SingleOrDefault(a => a.Id == newInsert.ApartmentId);
        ...
        public Base<UserViewModel> Update (UserInsertModel user, int id)
        {
            ...
            if (updateUser is not null)
            {
                ...
                {
                    var oldApartment = dbContext.Apartment
                        .SingleOrDefault(a => a.Id == oldApartmentId);
                    ...
                    var newApartment = dbContext.Apartment
                        .SingleOrDefault(a => a.Id == user.ApartmentId.Value);
