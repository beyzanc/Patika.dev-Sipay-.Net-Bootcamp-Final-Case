...
namespace ResiPay.Service.Message
{
    public class MessageService : IMessageService
    {
        ...
        public Base<MessageViewModel> SendMessage (MessageInsertModel messageInsert)
        {
            ...
            var sender = dbContext.User.SingleOrDefault(x => x.Id  == messageInsert.UserId);
            var receiver = dbContext.User.SingleOrDefault(x => x.Id == messageInsert.ReceiverId);
        ...
        public Base<MessageViewModel> UpdateMessage (MessageUpdateModel messageUpdate)
        {
            ...
            var model = dbContext.Message.SingleOrDefault(x => x.Id == messageUpdate.Id);
        ...
        public Base<MessageViewModel> DeleteMessage(int id)
        {
            ...
            var message = dbContext.Message.SingleOrDefault(x => x.Id == id && !x.IsDeleted);
        ...
        public Base<MessageViewModel> ReadMessage(int messageId)
        {
            ...
            var message = dbContext.Message.SingleOrDefault(x => x.Id == messageId && !x.IsDeleted);
